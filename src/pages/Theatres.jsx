        ...
        <div className="max-w-7xl mx-auto" style={{ backgroundColor: 'transparent' }}>
          ...
          >
            ...
            <motion.button
              ...
              onClick={handleRefresh}
              disabled={refreshing}
              className="bg-black text-white px-6 py-3 rounded-xl transition-all duration-200 disabled:opacity-50 flex items-center gap-2 mx-auto font-medium border border-gray-600 hover:border-gray-500 hover:bg-red-950"
            >
              <motion.div
